    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button className="bg-lime-500 hover:bg-lime-600 text-white">Deploy Agent</Button>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-lime-500 font-mono">23</p>
              </div>
              ...
              <tbody>
                {filteredAgents.map((agent, index) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      <Button variant="ghost" size="icon" className="text-neutral-400 hover:text-lime-500">
          ...
          <Card className="bg-neutral-900 border-neutral-700 w-full max-w-2xl">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2 pt-4">
                <Button className="bg-lime-500 hover:bg-lime-600 text-white">Assign Mission</Button>
                <Button
                  variant="outline"
