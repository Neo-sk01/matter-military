          ...
          <CardContent>
            <div className="grid grid-cols-3 gap-4 mb-6">
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-neutral-500">Valid</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white font-mono">290</div>
                <div className="text-xs text-neutral-500">Risky</div>
              </div>
            </div>
          ...
          <CardContent>
            <div className="space-y-3 max-h-80 overflow-y-auto">
              {[
                ...
                <div
                  key={index}
                  className="text-xs border-l-2 border-lime-500 pl-3 hover:bg-neutral-800 p-2 rounded transition-colors"
                >
                  <div className="text-neutral-500 font-mono">{log.time}</div>
                  <div className="text-white">
                    Agent <span className="text-lime-500 font-mono">{log.agent}</span> {log.action}{" "}
                    <span className="text-white font-mono">{log.location}</span>
                    {log.target && (
                      <span>
                        {" "}
                        with agent <span className="text-lime-500 font-mono">{log.target}</span>
                      </span>
                    )}
                  </div>
                </div>
        ...
        <Card className="lg:col-span-4 bg-neutral-900 border-neutral-700">
          ...
          <CardContent className="flex flex-col items-center">
            ...
            <div className="text-xs text-neutral-500 space-y-1 w-full font-mono">
              ...
              <div className="text-lime-500">{"> CH#2 | 1231.9082464.500...xR3"}</div>
