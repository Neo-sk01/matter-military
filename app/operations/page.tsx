    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button className="bg-lime-500 hover:bg-lime-600 text-white">New Operation</Button>
          <Button className="bg-lime-500 hover:bg-lime-600 text-white">Mission Brief</Button>
        </div>
      </div>
          ...
          <Card className="bg-neutral-900 border-neutral-700 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex gap-2 pt-4 border-t border-neutral-700">
                <Button className="bg-lime-500 hover:bg-lime-600 text-white">Update Status</Button>
                <Button
                  variant="outline"
