...
export default function SystemsPage() {
  ...
  const getHealthColor = (health) => {
    ...
    if (health >= 70) return "text-lime-500"
    return "text-red-500"
  }
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button className="bg-lime-500 hover:bg-lime-600 text-white">System Scan</Button>
          <Button className="bg-lime-500 hover:bg-lime-600 text-white">Maintenance Mode</Button>
        </div>
      </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-lime-500 font-mono">3</p>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        {systems.map((system) => (
          <Card
            key={system.id}
            className="bg-neutral-900 border-neutral-700 hover:border-lime-500/50 transition-colors cursor-pointer"
              ...
              <div className="grid grid-cols-3 gap-4 text-xs">
                <div>
                  ...
                  <div className="w-full bg-neutral-800 rounded-full h-1 mt-1">
                    <div
                      className="bg-lime-500 h-1 rounded-full transition-all duration-300"
          ...
          <Card className="bg-neutral-900 border-neutral-700 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex gap-2 pt-4 border-t border-neutral-700">
                <Button className="bg-lime-500 hover:bg-lime-600 text-white">Restart System</Button>
                <Button
                  variant="outline"
